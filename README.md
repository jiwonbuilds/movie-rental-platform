...
| Case 2: HTTP/10 threads                        | ![](logs/imgs/scaled_http_10threads.png)                | 264                        | 5.94182                              | 5.26093                    | There is a significant increase in the times compared to the single-threaded scaled configuration, suggesting potential performance challenges arising from the concurrent load. |
